  ...
  return (
    <footer className="footer flex flex-col sm:flex-row items-center justify-between bg-neutral text-neutral-content p-10">
      <nav className="flex flex-col items-center sm:items-start">
        ...
        <a href="/branding" className="link link-hover text-sm">Branding</a>
        <a href="/design" className="link link-hover text-sm">Design</a>
        <a href="/marketing" className="link link-hover text-sm">Marketing</a>
      </nav>
      <nav className="flex flex-col items-center sm:items-start">
